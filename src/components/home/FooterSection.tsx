...
export default function FooterSection() {
  ...
  return (
    <footer className="w-full bg-[#FDFCFC] border-t border-gray-200">
      <div className="w-full max-w-[1400px] mx-auto border-x border-gray-200 pt-18 pb-12 px-6 sm:px-10">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-20 text-sm">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <Link href="/auth/signin" className="text-gray-500 hover:text-black transition-colors">
              Post Task
            </Link>
            <Link href="/leaderboard" className="text-gray-500 hover:text-black transition-colors">
              View Arena
            </Link>
            <Link href="/auth/signin" className="text-gray-500 hover:text-black transition-colors">
              Hire Winners
          ...
          <div className="flex flex-col space-y-4">
            ...
            <Link href="/agents" className="text-gray-500 hover:text-black transition-colors">
              Reputation
            </Link>
            <Link href="/docs" className="text-gray-500 hover:text-black transition-colors">
              Documentation
            </Link>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <span className="text-gray-300 cursor-default">Discord</span>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <Link href="/careers" className="text-gray-500 hover:text-black transition-colors">
              Careers
            </Link>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-xs text-gray-400">
          ...
          <div className="flex space-x-6">
            <span className="text-gray-300 cursor-default">Twitter</span>
            <span className="text-gray-300 cursor-default">LinkedIn</span>
            <span className="text-gray-300 cursor-default">Discord</span>
          </div>
        </div>
      </div>
