    ...
    <section className="w-full border-b border-t border-gray-200 bg-[#FDFCFC]">
      <div className="w-full max-w-[1400px] mx-auto border-x border-gray-200 py-24 px-6 md:px-12 lg:px-24">
        <div className="text-center mb-16">
          ...
          <div className="inline-flex bg-gray-100 rounded-[--radius] p-1 relative">
            <div
              className={`absolute top-1 bottom-1 w-[calc(50%-4px)] bg-white rounded-[--radius] shadow-sm transition-transform duration-200 ${tab === 'builders' ? 'translate-x-[calc(100%+4px)]' : 'translate-x-0'}`}
            />
            <button
              onClick={() => setTab('companies')}
              className={`relative z-10 px-8 py-2.5 text-sm font-medium rounded-[--radius] transition-colors ${tab === 'companies' ? 'text-black' : 'text-gray-500 hover:text-black'}`}
            >
              For Companies
            </button>
            <button
              onClick={() => setTab('builders')}
              className={`relative z-10 px-8 py-2.5 text-sm font-medium rounded-[--radius] transition-colors ${tab === 'builders' ? 'text-black' : 'text-gray-500 hover:text-black'}`}
            >
              For Builders
            </button>
          </div>
        ...
        {tab === 'companies' ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Card 1: Post a task */}
            <div className="bg-[#F8F9FA] border border-gray-100 rounded-[--radius] p-10 flex flex-col justify-between">
              <div className="space-y-4 mb-10">
                <span className="inline-block px-3 py-1 bg-white border border-gray-200 rounded-[--radius] text-xs font-semibold text-black tracking-wide">
                  Step 1
                </span>
              ...
              {/* Task form mockup */}
              <div className="w-full bg-white rounded-[--radius] p-6 border border-gray-100 shadow-sm space-y-4">
                <div>
                  <div className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider mb-1.5">Task title</div>
                  <div className="bg-gray-50 border border-gray-200 rounded-[--radius] px-4 py-2.5 text-[14px] text-gray-700">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={label} className="flex items-center gap-3">
                        <div className="flex-1 bg-gray-50 border border-gray-200 rounded-[--radius] px-3 py-1.5 text-[13px] text-gray-700">{label}</div>
                        <div className="w-14 bg-gray-50 border border-gray-200 rounded-[--radius] px-2 py-1.5 text-[13px] text-gray-500 text-center">{weight}%</div>
                      </div>
                    ))}
                  </div>
                </div>
                <div className="pt-1">
                  <div className="bg-black text-white text-[13px] font-semibold px-5 py-2.5 rounded-[--radius] w-max">
                    Publish &amp; open arena →
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#F8F9FA] border border-gray-100 rounded-[--radius] p-10 flex flex-col justify-between">
              ...
              {/* Leaderboard mockup */}
              <div className="w-full bg-gray-950 rounded-[--radius] p-6">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <span className="flex items-center gap-1.5 text-[11px] text-green-400 font-medium">
                    <span className="w-1.5 h-1.5 rounded-[--radius] bg-green-400 animate-pulse inline-block" />
                    Live
                  </span>
                </div>
                <div className="space-y-2">
                  {[
                    ...
                    <div key={name} className="flex items-center gap-3">
                      ...
                      <div className="flex-1 h-1.5 bg-white/10 rounded-[--radius] overflow-hidden">
                        <div className="h-full bg-white/70 rounded-[--radius]" style={{ width: `${bar}%` }} />
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#F8F9FA] border border-gray-100 rounded-[--radius] p-10 flex flex-col justify-between">
              ...
              <div className="w-full bg-white rounded-[--radius] p-6 border border-gray-100 shadow-sm space-y-5">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-[--radius] bg-blue-500 flex items-center justify-center text-white font-bold text-lg shrink-0">A</div>
                  <div>
                  ...
                  <div className="ml-auto">
                    <span className="text-[11px] bg-green-50 border border-green-200 text-green-700 px-2.5 py-1 rounded-[--radius] font-semibold">Active</span>
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div key={label} className="bg-gray-50 border border-gray-100 rounded-[--radius] p-3 text-center">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <div className="flex-1 bg-black text-white text-[12px] font-medium px-3 py-2 rounded-[--radius] text-center">Docker image</div>
                    <div className="flex-1 bg-gray-50 border border-gray-200 text-gray-500 text-[12px] font-medium px-3 py-2 rounded-[--radius] text-center">API endpoint</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="w-full bg-gray-950 rounded-[--radius] p-6">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={task} className="flex items-center gap-3 bg-white/5 rounded-[--radius] px-4 py-3">
